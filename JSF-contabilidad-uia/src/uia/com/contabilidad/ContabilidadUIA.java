...
public class ContabilidadUIA {
		...
		public ArrayList<String> listaCuentasNames = null; /*NEW*/
		...
		{
		 contabilidad = new Gestor("C:\\Users\\jonat\\eclipse-workspace\\JSF-contabilidad-uia\\ListaProveedores.json");		
		...
		public ArrayList<String> getClientesNames(String clienteId) 
		{
				this.clienteId = clienteId;
				proveedor = (Proveedor) this.gestorProveedores.busca(clienteId);
				listaCuentasNames = proveedor.getListaNames();
