...
public class Principal {
	public static void main(String[] args) {
		...
		Gestor contabilidad = new Gestor(
				"C:\\Users\\jonat\\eclipse-workspace\\examen\\ListaProveedores.json");
		...
		Gestor contabilidad2 = new Gestor(
				"C:\\Users\\jonat\\eclipse-workspace\\examen\\cuentasXPagar.json");
		...
		cuenta  = (Cuenta) gestorCuentas.busca("Jonathan-compra-A-cuenta-1-Req-Cheques");
