...
public class Cheque extends InfoUIA {
	...
	NotaDesembolsoCheque minotaDesembolso= null;

	public Cheque() {
	}

	@JsonCreator
	public Cheque(@JsonProperty("id") int id, @JsonProperty("name") String name, @JsonProperty("estado") String status,
	...
	public void registraDesembolsoChequeConcepto(String nomCheque) {
		ListaInfoUIA lista = null;
		...
		int miId = this.getItems().size() + 1;
		minotaDesembolso = new NotaDesembolsoCheque(miId, "NotaDesembolso-" + nomCheque, "SinPagar", "14-11-2020","Desembolso efectivo");

		this.getItems().add(minotaDesembolso);
