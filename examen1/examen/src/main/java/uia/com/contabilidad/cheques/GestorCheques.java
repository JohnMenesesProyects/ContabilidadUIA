...
public class GestorCheques {
	...
	/*Funcionalidad añadida, con nota de concepto por desembolso*/
	public void registraChequeConcepto(Cuenta ccheques, String cuentaCheques, 
		...
		miCheque.registraDesembolsoChequeConcepto(concepto);
