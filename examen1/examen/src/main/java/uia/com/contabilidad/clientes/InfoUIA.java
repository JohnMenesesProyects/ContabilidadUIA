...
@JsonSubTypes({ @Type(value = Proveedor.class, name = "proveedor"), @Type(value = Cliente.class, name = "cliente"),
		@Type(value = Compra.class, name = "compra"), @Type(value = Requisicion.class, name = "requisicion"),
		@Type(value = Cuenta.class, name = "cuenta"), @Type(value = Cheque.class, name = "cheque"),
